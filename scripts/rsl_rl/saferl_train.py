...
# Import SafeRL VecEnv and OnPolicyRunner
...
from whole_body_tracking.utils.my_on_policy_runner import MotionSafeRLOnPolicyRunner as OnPolicyRunner
...
def main(env_cfg: ManagerBasedSafeRLEnvCfg, agent_cfg: RslSafeRlOnPolicyRunnerCfg):
