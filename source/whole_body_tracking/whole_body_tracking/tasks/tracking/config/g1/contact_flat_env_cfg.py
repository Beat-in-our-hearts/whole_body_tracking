...
from whole_body_tracking.tasks.tracking.tracking_contact_env_cfg import TrackingEnvCfg
...
@configclass
class G1BaselineFlatEnvCfg(G1FlatEnvCfg):
    def __post_init__(self):
        super().__post_init__()
        
        # no obs and reward for contact data, but keep metrics to record error_contact
