...
from whole_body_tracking.saferl.managers.cost_manager import CostTermCfg as CostTerm
...
class ObservationsCfg:
    ...
    class PolicyCfg(ObsGroup):
        ...
        # for contact data
        motion_contact_mask = ObsTerm(func=mdp.motion_contact_mask, params={"command_name": "motion"})
...
@configclass
class TrackingEnvCfg(ManagerBasedSafeRLEnvCfg):
